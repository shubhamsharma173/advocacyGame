...
class FlashingIconsGrid2 extends StatefulWidget {
  @override
  _FlashingIconsGridState createState() => _FlashingIconsGridState();
}

class _FlashingIconsGridState extends State<FlashingIconsGrid2> {
  List<String> images = [
    'assets/icons/gold/2.png',
    'assets/icons/white/a.png',
  ...
  Widget build(BuildContext context) {
    ...
    final gridView = GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return InkWell(
          onTap: () {
            if (image == 'assets/icons/gold/2.png') {
              setState(() {
                _isOverlayVisible = true;
              });
            }
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => FlashingIconsGrid3()));
                },
                child: Container(
