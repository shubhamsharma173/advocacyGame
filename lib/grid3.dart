...
class FlashingIconsGrid3 extends StatefulWidget {
  @override
  _FlashingIconsGridState createState() => _FlashingIconsGridState();
}

class _FlashingIconsGridState extends State<FlashingIconsGrid3> {
  List<String> images = [
    'assets/icons/gold/3.png',
  ...
  Widget build(BuildContext context) {
    ...
    final gridView = GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return InkWell(
          onTap: () {
            if (image == 'assets/icons/gold/3.png') {
              setState(() {
                _isOverlayVisible = true;
              });
            }
